# SafeTag — Codex Developer Guide

This file exists so every new Codex session starts with full project context. Update it whenever a design decision is finalized or a convention changes.
...
```
Co-Authored-By: Nitish | Codex
```
Do NOT use the default `Co-Authored-By: Codex Sonnet 4.6 <noreply@anthropic.com>`.
